...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'lactose':
				dialogue = CoolUtil.coolTextFile(Paths.txt('lactose/lactoseDialogue'));
			case 'intolerance':
				dialogue = CoolUtil.coolTextFile(Paths.txt('intolerance/intoleranceDialogue'));
		}
			...
			case 'milkstage':
				{
					defaultCamZoom = 0.9;
						curStage = 'milkstage';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('milkstage', 'shared'));
						bg.antialiasing = true;
		...
		if (curSong == 'lactose' || curSong == 'intolerance'){
